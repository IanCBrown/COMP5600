...
def q_learning(learning_rate, discount, epsilon, min_epsilon, episodes):
...
def single_run():
    ...
    """
    rewards_and_var = q_learning(learning_rate, gamma, epsilon, min_epsilon, number_of_episodes)
...
def multi_run(N):
    ...
    plt.savefig("q_learning_results/Average_Reward_vs_Episodes.png")
    plt.figure("Variance vs. Episodes")
    plt.title("Variance vs. Episodes")
    plt.xlabel("Episodes")
    plt.ylabel("Variance")
    plt.plot(episodes2, var_to_plot, color='orange')
    plt.savefig("q_learning_results/Variance_vs_Episodes.png")
    plt.figure("Average Reward w/ Variance vs. Episodes")
    plt.title("Average Reward w/ Variance vs. Episodes") 
    plt.xlabel("Episodes")
    plt.ylabel("Average Reward w/ Variance")
    plt.errorbar(episodes1, reward_to_plot, var_to_plot, linestyle='None', marker='^', ecolor="orange")
    plt.savefig("q_learning_results/Average_Reward_and_Variance_vs_Episodes.png")
